<<<<<<< HEAD
# Generated by Django 4.1.4 on 2023-01-14 12:17
=======
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bios', models.TextField(blank=True, default='write you bio here...')),
                ('applyjobs', models.JSONField(blank=True, default=dict)),
<<<<<<< HEAD
=======
                ('statusforapplyjobs', models.TextField()),
>>>>>>> a4ccb751e29506b45a59f96d9eb81344f82010e9
                ('cvcandidate', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='users.cvformmodel')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
